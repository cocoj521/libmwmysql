#ifndef __MYSQL_SQLVALUE_H__
#define __MYSQL_SQLVALUE_H__

#include "SQLTypes.h"

namespace MYSQL_SQLVALUE_NSAMESPACE {
...
public:
    CSQLValue();
    CSQLValue(const char* pData, unsigned long nLength, MYSQL_SQLTYPES_NSAMESPACE::SQLType::e_Type eType=MYSQL_SQLTYPES_NSAMESPACE::SQLType::eBLOB);
    CSQLValue(const CSQLValue& rValue);
    virtual ~CSQLValue();
protected:
    char* m_pData;
    unsigned long m_nLength;
    MYSQL_SQLTYPES_NSAMESPACE::SQLType::e_Type   m_eType;
public:
    ...
    inline MYSQL_SQLTYPES_NSAMESPACE::SQLType::e_Type GetType() const
    {
        return m_eType;
    }
    ...
    {
        return (MYSQL_SQLTYPES_NSAMESPACE::SQLType::eBLOB == m_eType);
    }
